...
import Solicitud_UAEH from '../Components/Solicitud_uaeh';
    ...
    <div>
      ...
      <DashboardWrapper expanded={expanded}>
        ...
        <Content>
          ...
          {selectedItem === 'Section1' && <Solicitud_UAEH /> }
