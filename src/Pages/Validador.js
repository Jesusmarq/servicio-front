...
const BrighterColor = '#9E2343';  //#98989A;VEDA 
const LineColor = '#BC955B';//  #ccc veda
const SelectedColor = '#9E2343';  //#98989A; VEDA 
...
background-color: #9E2343 ; //#98989A; VEDA 
  color: white;
  padding: 15px;
  font-size: 20px;
  border: none;
  ...
  &:hover {
    background-color: #7a1c33 ;/*#ccc; VEDA */
