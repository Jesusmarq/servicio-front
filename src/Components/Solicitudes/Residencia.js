...
const fecha =`                                                                                                                                                     
 ...
 pdf.text(linese, xPosition, yPosition);  
  ...
  const saludo =` Sin otro particular por el momento, le reitero mis más distinguida consideración y respeto.`;
  yPosition += 30;
