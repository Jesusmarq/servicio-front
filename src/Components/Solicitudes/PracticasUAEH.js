...
//-----------------para que se muestre en la tabla------------------------
  ...
  ////---------------para  almacenar los datos del modal-----------------
    ...
    const handleChange = (field, value) => {
      ...
      // Aquí puedes hacer cualquier otra lógica necesaria
    };
