...
function ServicioSocial ({ title }) {
  const [data, setData] = useState([
    { id: 1, nombre: 'Gloria Mendoza', tipoSolicitud: 'Proyecto de Intervención', cartaPresentacion: 'Carta-de-presentacion.pdf', fecha: '01/01/2023', validar: false },
    { id: 2, nombre: 'Mauricio Flores', tipoSolicitud: 'Proyecto de Intervención', cartaPresentacion: 'Carta-de-presentacion.pdf', fecha: '15/01/2023', validar: false },
    { id: 3, nombre: 'Lorena Soto', tipoSolicitud: 'Proyecto de Intervención', cartaPresentacion: 'Carta-de-presentacion.pdf', fecha: '10/02/2023', validar: true },
    { id: 4, nombre: 'Roberto Salgado', tipoSolicitud: 'Proyecto de Intervención', cartaPresentacion: 'Carta-de-presentacion.pdf', fecha: '12/03/2023', validar: false },
    { id: 5, nombre: 'Ana María Jiménez', tipoSolicitud: 'Proyecto de Intervención', cartaPresentacion: 'Carta-de-presentacion.pdf', fecha: '18/04/2023', validar: false },
    { id: 6, nombre: 'Francisco Guzmán', tipoSolicitud: 'Proyecto de Intervención', cartaPresentacion: 'Carta-de-presentacion.pdf', fecha: '22/05/2023', validar: false },
    { id: 7, nombre: 'Sandra Ortega', tipoSolicitud: 'Proyecto de Intervención', cartaPresentacion: 'Carta-de-presentacion.pdf', fecha: '02/06/2023', validar: false },
    { id: 8, nombre: 'Carlos Sánchez', tipoSolicitud: 'Proyecto de Intervención', cartaPresentacion: 'Carta-de-presentacion.pdf', fecha: '15/07/2023', validar: false },
    { id: 9, nombre: 'Elena Martínez', tipoSolicitud: 'Proyecto de Intervención', cartaPresentacion: 'Carta-de-presentacion.pdf', fecha: '28/08/2023', validar: false },
    { id: 10, nombre: 'Javier Rodríguez', tipoSolicitud: 'Proyecto de Intervención', cartaPresentacion: 'Carta-de-presentacion.pdf', fecha: '10/09/2023', validar: false },
    // ... más datos
  ]);
