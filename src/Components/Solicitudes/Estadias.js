...
const fecha =`                                                                                                                                                     
 ...
 pdf.text(linese, xPosition, yPosition);  
  ...
  const saludo =` Sin otro particular por el momento, le reitero mi más distingida consideración y repeto.`;
  yPosition += 30;
