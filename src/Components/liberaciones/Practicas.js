...
function PracticasProfesionales2 ({ title }) {
  ...
  pdf.setFontSize(12); // Ajusta el tamaño según tus preferencias
    ...
    ${modalData.numeroControl}, alumn@ de la ${modalData.carrera}, ha concluido sus Prácticas 
    Profesionales en la ${modalData.dependencia}, cubriendo el periodo del ${modalData.periodo}, 
    de lunes a viernes en un horario de ${modalData.horario} hrs.,siendo asignado a la 
    ${modalData.direccionGeneral}, bajo el Programa: 
    “${modalData.programa}” clave: ${modalData.clave}, 
...
export default PracticasProfesionales2;