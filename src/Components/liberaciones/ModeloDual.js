  ...
  const fetchDataTabla = async () => {
    try {
      ...
      //  console.log(responseData);
        ...
        const solicitudesFiltradas = responseData.solicitudes.filter(solicitud => solicitud.tipo === 'Modelo Dual' && solicitud.universidad === 'SEMSyS');
