...
function ServicioSocial2 ({ title }) {
    const [data, setData] = useState([
    { id: 1, nombre: 'Víctor Daniel Acosta', escuela:'OTRAS', tipoSolicitud: 'Servicio Social', cartaPresentacion: 'Carta-de-presentacion.pdf', fecha: '01/01/2023', validar: false },
  ...
  pdf.setFontSize(12); // Ajusta el tamaño según tus preferencias
    ...
    Por medio del presente informo a usted que el C.${modalData.nombreEstudiante}, con número de control 
    ${modalData.numeroControl}, alumn@ de la ${modalData.carrera}, ha concluido su Servicio Social 
...
export default ServicioSocial2;