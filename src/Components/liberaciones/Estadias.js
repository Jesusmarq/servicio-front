...
function ServicioSocial ({ title }) {
  const [data, setData] = useState([
    { id: 1, nombre: 'Victor Daniel Acosta', tipoSolicitud: 'Estadía', cartaPresentacion: 'Carta-de-presentacion.pdf', fecha: '01/01/2023', validar: false },
    { id: 2, nombre: 'Jesus Adolfo Marquez', tipoSolicitud: 'Estadía', cartaPresentacion: 'Carta-de-presentacion.pdf', fecha: '15/01/2023', validar: false },
    { id: 3, nombre: 'Julian Trejo Melchor', tipoSolicitud: 'Estadía', cartaPresentacion: 'Carta-de-presentacion.pdf', fecha: '10/02/2023', validar: true },
    // ... más datos
  ]);
...
// Cargar Montserrat Regular
 ...
 const textoPDF = `
                                                  ...
                                                  Carta de Terminación de Estadía
