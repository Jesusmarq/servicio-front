...
function Estadia2({ title }) {
  const [data, setData] = useState([
    { id: 1, nombre: 'Victor Daniel Acosta',  cartaPresentacion: 'Carta-de-presentacion.pdf', fecha: '01/01/2023', validar: false },
    { id: 2, nombre: 'Jesus Adolfo Marquez',  cartaPresentacion: 'Carta-de-presentacion.pdf', fecha: '15/01/2023', validar: false },
    { id: 3, nombre: 'Julian Trejo Melchor', cartaPresentacion: 'Carta-de-presentacion.pdf', fecha: '10/02/2023', validar: true },
    // ... más datos
  ]);
        ...
        <StyledTable>
          <thead>
            <tr>
              ...
              <StyledTh>Liberar Alumno</StyledTh>
            </tr>
          </thead>
          <tbody>
            {data.map((item, index) => (
